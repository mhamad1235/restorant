...
<div class="container mt-5">
	<button class="btn btn-primary my-5">گەڕانەوە </button>
				...
				<div class="float-start rounded m-2 col single-table" id="<?php echo $data['id']; ?>" onclick="directpage('<?php echo $data['id']; ?>')">
					<div class="table-box bg2 text-center rounded border  p-1" style="background-color: rgba(0, 0, 0, 0.1);">
						<div class=" col-sm-1 col-3 float-start text-left">
							...
							<i class="fa fa-circle mr-2 dot-success float-right text-success" aria-hidden="true" style="font-size: 75%;margin-top: -4px"></i>
						</div>
...
$(".table-box").hover(function(){
    ...
    // $((".table_No")[$(".table-box").index(this)]).css("color","yellow");
    // $(".table_No")[0].css("color","yellow");
    // $((".table_No")[0]).css("background-color","yellow");
    // $((".table_No")[$(".table-box").index(this)]).css("transition-duration","800ms");
	// console.log(this);
	// console.log($(".table_No")[$(".table-box").index(this)]);
	// console.log($(".table_No").index(1));
},function(){
	$(this).css("scale","1");
	$(this).css("box-shadow","none");
	$(".table-box").css("transition-duration","none");
    // $((".table_No")[$(".table-box").index(this)]).css("color","red");
    // $((".table_No")[$(".table-box").index(this)]).css("color","black");
    // $((".table_No")[$(".table-box").index(this)]).css("transition-duration","none");
});
