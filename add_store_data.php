<?php
	...
	if(!empty($_POST))
	{
		...
		$message = "کۆگاکە بەسەرکەوتوویی زیادکرا";
		    		...
		    		$output .= "
				    	<tbody
					    	<tr>
					      		...
					      		<td>
					      			<div class='row'>
					      				<button type='submit' name='edit' id='" . $data['id'] . "' class='btn btn-sm btn-primary ml-2 edit_data'>دەستکاری</button>
					      				<a href='delete_table.php?id=" . $data['id'] . "' name='cancel' class='btn btn-sm btn-danger delete_data'>ڕەشکردنەوە</a>
					      			</div>
					      		</td>
					    	</tr>
					    </tbody>
