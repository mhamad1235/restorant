...
if (!empty($_POST)) {
	...
	$message = "گروپەکە بەسەرکەووتوویی زیادکرا";
					    	...
					    	<tr>
					      		...
					      		<td>
					      			<div class='row'>
					      				...
					      				<a href='delete_group.php?id=" . $data['id'] . "' name='cancel' class='btn btn-sm btn-danger delete_data'>ڕەشکردنەوە</a>
					      			</div>
					      		</td>
					    	</tr>
					    </tbody>
