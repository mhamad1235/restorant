...
$queryy = "select * from temporary_order join add_product where product_id=$product_id and table_id=$table_id and quantity>=1";
...
<div class="d-flex align-content-center align-items-center justify-content-between">
        ...
        <div  id="remove-btn"><i role="button" class="fa-sharp fa-solid fa-xmark shadow-lg  bg-danger text-light pointer rounded p-2 px-2"  ></i></div>
    </div>
<?php
    }
}
