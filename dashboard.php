...
if (!isset($email) || !isset($_SESSION['admin'])) {
...
<head>
	...
	<!-- <script src="cdn/fontawesomekit.js"></script> -->
...
<body>
	<div class="wrapper menuDisplayed">
							...
							<div class="col-md-12">
								...
								<div class="row justify-content-center align-items-center align-content-center">
									<div class="col-12 col-md-5 mx-auto total-notifications shadow-md">
										...
										<a href="notification_page.php" class="btn btn-primary btn-sm w-100 mt-4 mx-auto text-center"><i class="fas fa-arrow-circle-right ml-1"></i>بینینی ئاگادارکردنەوەکان </a>
									</div>
									<div class="col-12 col-md-5 mx-auto total-products shadow-md mt-5 mt-md-0">
										...
										<a href="manage_product.php" class="btn btn-danger btn-sm w-100 mt-4 mx-auto text-center"><i class="fas fa-arrow-circle-right ml-1"></i>بینینی بەرهەمەکان </a>
									</div>
									<div class="col-12 col-md-5 mx-auto total-orders shadow-md mt-5">
										<div class="row">
											<div class="col-md-8">
												<h1 class="text-white"><?php $query = "select * from orders group by bill_id";
																		$result = mysqli_query($connect, $query);
																		$count = mysqli_num_rows($result);
																		echo $count;
																		?></h1>
										...
										<a href="analytics.php" class="btn btn-success btn-sm w-100 mt-4 mx-auto text-center"><i class="fas fa-arrow-circle-right ml-1"></i>بینینی داواکارییە دراوەکان </a>
									</div>
									<div class="col-12 col-md-5 mx-auto total-users shadow-md mt-5">
										...
										<a href="manage_user.php" class="btn btn-warning btn-sm w-100 mt-4 mx-auto text-center text-white"><i class="fas fa-arrow-circle-right ml-1"></i>بینینی بەکارهێنەران </a>
									</div>
