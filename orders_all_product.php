...
$result = mysqli_query($connect, "SELECT * FROM add_product join subcat on add_product.subcat_id=subcat.id join category on subcat.cat_id=category.id  ORDER BY add_product.id DESC ");
