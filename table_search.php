			...
			?>
					...
					<tr>
						...
						?>
							...
							<td>
								<div class="row">
									...
									<button type="submit" name="cancel" class="btn btn-sm btn-danger">ڕەشکردنەوە</button>
								</div>
							</td>
						<?php
						} else {
						?>
							...
							<td>
								<div class="row">
									<button type="submit" name="edit" id="<?php echo $data['id']; ?>" class="btn btn-sm btn-primary ml-2 edit_data">ڕەشکردنەوە</button>
									<button type="submit" name="cancel" class="btn btn-sm btn-danger">ڕەشکردنەوە</button>
								</div>
							</td>
						<?php
