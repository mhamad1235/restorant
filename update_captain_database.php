...
if (isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['email']) && isset($_POST['userid'])) {
	...
	$query = "UPDATE add_user SET firstName = '$first_name', lastName = '$last_name', email = '$email' WHERE id = $userid ";
	...
	if (mysqli_query($connect, $query)) {
		...
		$select = "SELECT * FROM add_user WHERE id = $userid";
					...
					<form method="POST" action="" class="w-100 p-3" id="update_form">
						<div class="form-group">
					  	...
					  	<div class="form-group">
					    	...
					    	<input type="text" name="first_name" class="form-control shadow-none" id="first_name" placeholder="Enter First Name" value="' . $data["firstName"] . '">
					  	</div>
					  	<div class="form-group">
					    	<label for="last_name" style="font-weight: 600;">Last Name</label>
					    	<input type="text" name="last_name" class="form-control shadow-none" id="last_name" placeholder="Enter Last Name" value="' . $data["lastName"] . '">
					  	</div>
					  	<div class="form-group">
