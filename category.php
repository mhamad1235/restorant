						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								<div class="top-part mb-3"> <a href="dashboard.php" class="d-inline text-dark mt-2" style="text-decoration: none; float: left; font-weight: 500;">داشبۆڕد <i class="fas fa-tachometer-alt "></i> </a>
									<h2 class="d-inline">بەڕێوەبردنی پۆڵێنەکان</h2>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<button class="btn btn-primary add-group shadow-none" data-toggle="modal" data-target="#AddModal">زیادکردنی پۆڵێن</button>
									</div>
									...
									<div class="col-md-4 mt-2 mb-4 ml-auto">
										<div class="input-group">
											<input type="text" name="search" id="search" onkeyup="SearchField();" class="form-control shadow-none" placeholder="گەڕان بەدوای پۆڵێنەکان">
														...
														?>
															...
															<td>
																<div class="row">
																	...
																	<a href="delete_category.php?id=<?php echo $data['id']; ?>" name="cancel" class="btn btn-sm btn-danger">ڕەشکردنەوە</a>
																</div>
															</td>
														<?php
														} else {
									...
									<nav aria-label="Page navigation example" style="background-color: transparent;">
										<ul class="pagination justify-content-end">
											...
											<?php if ($page >= 1) { ?>
												...
												<li class="page-item "><a href="<?php echo 'category.php?page=' . $page_next ?>" class="page-link">دواتر</a></li>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content text-right">
				<div class="modal-header mx-auto"> <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					...
					<h4 class="modal-title text-center text-info" id="exampleModalCenterTitle">زیادکردنی پۆڵێن</h4>

				</div>
				<div class="modal-body">
					<form method="POST" action="" id="add_form">
						<div class="form-group">
							<label for="categoryName">ناوی پۆڵێن</label>
							<input type="text" name="category_name" class="form-control shadow-none" id="category_name" aria-describedby="emailHelp" placeholder="ناوی پۆڵێن بنووسە">
						</div>
						<div class="form-group">
						...
						<button type="submit" name="add" id="add" class="btn btn-primary shadow-none">زیادکردنی پۆڵێن</button>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content text-right">
				<div class="modal-header mx-auto"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
					...
					<h4 class="modal-title text-center text-info" id="exampleModalCenterTitle">نوێکردنەوەی پۆڵێن</h4>
				...
				<div class="modal-body">
					<form method="POST" action="" id="update_form">
						...
						<button type="submit" name="update" id="update" class="btn btn-primary shadow-none">نوێکردنەوەی پۆڵێن</button>
						<button type="button" class="btn btn-danger shadow-none" data-dismiss="modal" aria-label="Close">پاشگەزبوونەوە</button>
					</form>
				</div>
			</div>
