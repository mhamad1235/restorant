...
$table_id = $_GET['table_id'];
    ...
    $queryyy = "delete from temporary_order
        where product_id=$product_id and table_id=$table_id";
...
<!-- 
	...
	<div class="d-flex align-content-center align-items-center justify-content-between">
									<div class="d-flex text-center mx-auto justify-content-between align-items-center align-content-center my-3 p-1 rounded ordered-product" style="width: 240px; height: 100px;background-color:#D8D2CB;border: 2px solid #94908B;">
        ...
        <div class="d-flex text-center  justify-content-between align-items-center align-content-center my-3 p-1 rounded" style="width: 240px; height: 100px;background-color:#D8D2CB;border: 2px solid #94908B;">
            ...
            <div class="d-flex flex-column justify-content-between align-items-center mr-1 mt-3">
                ...
                <div class="d-flex mb-2">
                    <div>
                        <button class="px-2 text-white addition" id="<?php echo $data["id"]; ?>"  style="background-color:#83BD75;border-radius:50%;cursor: pointer;" value='<?php echo $table_id; ?>' onclick="" >+</button>
                    </div>
                    <div>
                        <p class="col pt-2"> <?php echo $data['quantity']; ?></p>
                    </div>
                    <div>
                        <button class="px-2 text-white subtraction" value='<?php echo $table_id; ?>' id="<?php echo $data["id"]; ?>" style="background-color:#B73E3E;border-radius:50%;cursor: pointer;"  onclick="">-</button>
                    </div>
                </div>
            </div>
            <div>
