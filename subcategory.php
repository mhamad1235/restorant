...
$result1 = mysqli_query($connect, "SELECT * FROM subcat");
...
$result = mysqli_query($connect, "SELECT * FROM subcat ORDER BY id DESC LIMIT $this_page_first_result, $results_per_page");
$count = mysqli_num_rows($result);

if ($page > $number_of_pages) {
	header('Location: subcat.php?page=' . $number_of_pages);
}
									...
									<nav aria-label="Page navigation example" style="background-color: transparent;">
										<ul class="pagination justify-content-end">
											...
											<?php if ($page > 1) { ?>
												...
												<li class="page-item"><a href="<?php echo 'subcategory.php?page=' . $page_previous ?>" class="page-link">Previous</a></li>

											<?php } ?>

											<?php
											for ($page = 1; $page <= $number_of_pages; $page++) {
												echo '<li class="page-item"><a href="subcategory.php?page=' . $page . '" class="page-link">' . $page . ' ' . '</a></li>';
											}
											?>

											<?php if ($page >= 1) { ?>

												<li class="page-item "><a href="<?php echo 'subcategory.php?page=' . $page_next ?>" class="page-link">دواتر</a></li>
